...
RUN wget -nv -O "weewx-${WEEWX_VERSION}.tar.gz" "https://github.com/weewx/weewx/archive/refs/tags/v${WEEWX_VERSION}.tar.gz" &&\
    ...
    wget -nv -O "weewx-xcumulative.zip" "https://github.com/gjr80/weewx-xcumulative/releases/download/v0.1.0/xcum-0.1.0.tar.gz" &&\
...
RUN bin/wee_extension --install /tmp/weewx-interceptor.zip &&\
    ...
    bin/wee_extension --install /tmp/weewx-xcumulative.zip &&\
